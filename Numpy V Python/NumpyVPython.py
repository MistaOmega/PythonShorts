...
plt.title('Performance Comparison: NumPy vs Python', fontsize=14, color=text_color)
...
plt.annotate('Switching Point', xy=(array_sizes[1], python_times[1]), xytext=(array_sizes[1], python_times[1]*10),
...
# Save the plot
plt.tight_layout()
plt.savefig('numpy_vs_python.png')
plt.close() 